...
animals.push('eagle','worm','koala','cat');
...
let assortedThings = ['Eevee', 'Percy', 'Natasha', 3, 3, 14];
...
arrayOfNumbers([7,300,-9])
arrayOfNumbers([-100,200,5])
arrayOfNumbers([-3,100,'Awesome'])
